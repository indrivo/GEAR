...
namespace ST.Backup
{
    public static class BackupProvider
    {
        public static class MsSql
        {
            ...
            public static void Backup(MsSqlBackupSettings settings, string directoryPath)
            {
                //TODO: Backup for MSSql database
        ...
        public static class PostGreSql
        {
            ...
            /// <param name="settings"></param>
            /// <param name="directoryPath"></param>
            public static void Backup(PostGreSqlBackupSettings settings, string directoryPath)
            {
