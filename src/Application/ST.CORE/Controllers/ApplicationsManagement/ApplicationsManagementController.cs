...
using ST.CORE.ViewModels.PermissionViewModels;
...
namespace ST.CORE.Controllers.ApplicationsManagement
{
	[Authorize]
	public class ApplicationsManagementController : Controller
	{
		...
		public ApplicationsManagementController(ConfigurationDbContext configurationDbContext,
			...
			ILogger<ApplicationsManagementController> logger, IPermissionService permissionService)
		{
		...
		public IActionResult Create(ApiClientCreateViewModel model)
		{
