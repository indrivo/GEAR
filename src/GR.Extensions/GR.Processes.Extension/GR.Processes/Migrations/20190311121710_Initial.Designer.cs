...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GR.Procesess.Models.STIncomingTransition", b =>
                {
            ...
            modelBuilder.Entity("GR.Procesess.Models.STOutgoingTransition", b =>
                {
                    b.Property<Guid>("ProcessTransitionId");
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessInstanceHistory", b =>
                {
                    b.Property<Guid>("ProcessTransitionId");
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessSchema", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessTransition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STTransitionActor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.UserProcessTasks", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Procesess.Models.STIncomingTransition", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcessTransition", "IncomingTransition")
            ...
            modelBuilder.Entity("GR.Procesess.Models.STOutgoingTransition", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcessTransition", "OutgoingTransition")
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcess", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcess", "IntitialProcess")
                        .WithMany()
                        .HasForeignKey("IntitialProcessId");

                    b.HasOne("GR.Procesess.Models.STProcessSchema", "ProcessSchema")
                        .WithMany()
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessInstance", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcess", "Process")
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessInstanceHistory", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcessInstance", "ProcessInstance")
                        .WithMany()
                        .HasForeignKey("ProcessInstanceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GR.Procesess.Models.STProcessTransition", "ProcessTransition")
                        .WithMany()
            ...
            modelBuilder.Entity("GR.Procesess.Models.STProcessSchema", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcessSchema", "InitialSchema")
                        .WithMany()
            ...
            modelBuilder.Entity("GR.Procesess.Models.UserProcessTasks", b =>
                {
                    b.HasOne("GR.Procesess.Models.STProcessTask", "ProcessTask")
                        .WithMany()
