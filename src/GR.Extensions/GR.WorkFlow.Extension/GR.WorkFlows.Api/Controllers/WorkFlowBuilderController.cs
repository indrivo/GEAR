...
namespace GR.WorkFlows.Api.Controllers
{
    ...
    public class WorkFlowBuilderController : BaseGearController
    {
        ...
        [HttpGet]
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<WorkFlowGetViewModel>))]
        ...
        [HttpGet]
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<Transition>))]
        ...
        [HttpGet]
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<StateGetViewModel>))]
        ...
        [HttpGet]
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<IEnumerable<WorkflowAction>>))]
