...
namespace ST.Configuration.Seed
{
    ...
    {
        public static SeedApplication ReadData(string filePath)
        {
            ...
            try
            {
                ...
                using (var reader = new JsonTextReader(sReader))
                {
                    ...
                    entity = fileObj.ToObject<SeedApplication>();
                }
        ...
        public async Task SeedAsync(ApplicationDbContext context, IServiceProvider services)
        {
            ...
            var entity = ReadData(Path.Combine(baseDirectory, "IdentityConfiguration.json"));
